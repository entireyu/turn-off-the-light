...
var btnGroup = [{ name: "简单", func: () => { game = new Game(1); game.init(); } }, { name: "中等", func: () => { game = new Game(3); game.init(); } }, { name: "困难", func: () => { game = new Game(5); game.init(); }}, { name: "特困", func: () => { game = new Game(10); game.init(); } }, { name: "地狱(增强版)", func: () => { game = new Game(26); game.init(); } }]
